export default {
  ...
  description: {
    ...
    es: 'Los valored del Vanguard busca la tradición, la estructura y el orden en la sociedad. Su castillo se puede encontrar en una desarrollada área verde alrededor de Guardstone.',
