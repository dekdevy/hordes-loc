export default {
  ...
  description: {
    ...
    ru: 'Орда Кровожадности ценит свободу и лояльность, предлагая место для индивидуализма или даже хаоса. Их оборона находится в пустынном мире, названном Headless Landing.',
    ...
    it: 'L\'orda degli Assetati di Sangue dà estrema importanza alla lealtà ed alla libertà, ed offre un posto ad individualisti e caotici. La loro roccaforte è situata in un regno desertico chiamato Headless Landing.',
