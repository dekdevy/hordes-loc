export default {
  ...
  description: {
    ...
    es: 'La horda Bloodlust valora la libertad y lealtad,ofrece un lugar para el individualismo o incluso el caos. Sus defensas están ubicadas en un reino del desierto llamado Desembarco sin cabeza.',
