export default {
  interactions: [{
    text: {
      ...
      ph: 'Ah nakikita kita mong biyahero. Nagagalit at gutom na tinitingnan mo. Tayong mga conjurer ay naglalakbay rin sa mga pinong lupain. Gusto mo bang dalhin ka sa isa?',
      bg: 'О, виждам ви пътешественик. Изморени и уморени изглеждате. Ние, фокусниците, прекосяваме тези прекрасни земи. Искаш ли да те заведа на едно?',
      el: 'Σας βλέπω να ταξιδεύετε. Κόκκινος και φτωχός κοιτάζετε. Εμείς οι περιπλανώμενοι περιπλανώνουμε αυτές τις ωραίες εκτάσεις. Θα θέλατε να σας μεταφέρω σε ένα;',
