export default {
  interactions: [{
    ...
    text: {
      ...
      fr: 'Avez-vous entendu parler des Éclats de Cristal (Crystal Shards) qui ont été découverts récemment ? Les aventuriers peuvent les utiliser pour voyager directement vers des royaumes lointains. Je n\'ai pas d\'Éclats de Cristal, mais je peux vous envoyer à certains endroits où les forces mystiques convergent. Quel royaume désirez-vous avoir comme destination?',
