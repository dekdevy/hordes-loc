export default {
  interactions: [{
    ...
    text: {
      ...
      bg: 'Надстройването е рисковано без допълнителни специални елементи като Blacksmith\'s Blessed Hammer, което може да попречи на елементите да се счупят по време на надстройките. Без чука ще рискуваме. Та има ли нещо, което мога да подобря за вас?',
