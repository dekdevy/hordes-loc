export default {
  interactions: [{
    ...
    text: {
      ...
      fr: 'Améliorer vos objets est risqué sans l\'aide d\'un autre objet spécial, tel que le Blacksmith\'s Blessed Hammer, qui les empèche de briser durant leurs amélioration. Sans ce marteau, nous prenons un risque. Bon, avez-vous quelque chose que je pourrais améliorer pour vous aujourd\'hui?',
