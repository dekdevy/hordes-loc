export default {
  interactions: [{
    ...
    text: {
      ...
      es: 'Bueno, ¡mira lo que tenemos aquí! No, ese equipamiento no será suficiente, ¿verdad? ¡Échale un vistazo al mercado abierto! Se están difundiendo rumores: escuché que los Warcry Scrolls pueden teletransportar a un amigo a tu posición. Dejémoslo entre nosotros, ¿okey?',
    ...
    choices: [{
      ...
      es: 'Sí, muéstrame los ítems en venta.',
