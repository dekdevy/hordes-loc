export default {
  interactions: [{
    text: {
      ...
      tr: 'Çevredeki en iyi eşya satıcısına hoş geldiniz! Sana sunduğum\'dan daha iyi bir anlaşma bulamayacaksın; Ancak, şimdiye kadar gördüğüm hiçbir şeye benzemeyen fantastik eşyalara sahip özel bir dükkan olduğunu duydum. Bu arada, bazı yedek paralarım ve yedek mallarım var. Bir şey satmak ister misin?'
    },
