export default {
  interactions: [{
    text: {
      ...
      zh: '歡迎來到各地最好的商品！ 你不會找到比我給你更好的交易; 然而，我聽說有一個特別的商店，有很棒的物品，不像我見過的任何東西。 與此同時，我有一些備用硬幣和備用貨物。 你要提供什麼？'
    },
  ...
  buy: {
    ...
    it: 'Sei interessato a qualcosa? Clicca su un articolo per comprarlo.',
    pl: 'Interesuje cię coś? Kliknij artykuł, aby go kupić.',
    
    sv: 'Är du intresserad av något? Klicka på en sak för att köpa den.',
    ko: '관심이 있습니까? 항목을 클릭하여 구입하십시오.',
    fr: 'Êtes-vous intéressé par quelque chose? Cliquez sur un item pour l\'acheter.',
    pt: 'Você está interessado em alguma coisa? Clique em um item para comprá-lo.',
    hi: 'क्या आप किसी चीज में रुचि रखते हैं? इसे खरीदने के लिए किसी आइटम पर क्लिक करें।',
    it: 'Sei interessato a qualcosa? Fai clic su un oggetto per acquistarlo.',
    ...
    pl: 'Czy jesteś czymś zainteresowany? Kliknij przedmiot, aby go kupić.',
