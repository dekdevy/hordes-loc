export default [
...

  {
    ...
    description: {
      ...
      bg: 'Гнило залък от реколта от последните години.',
...

  {
    ...
    description: {
      ...
      bg: 'Тънка филийка от гранит, идеална за подскачане през вълните на езерото.',
...

  {
    ...
    description: {
      ...
      bg: 'Сияещата сребриста тъкан се казва, че е открадната от самата Афродита.',
...

  {
    ...
    description: {
      ...
      bg: 'Студената и синя висулка открадва топлината ви като плащане за ефектите ...',
...

  {
    ...
    description: {
      ...
      bg: 'Изненадващо не мирише на риба. Просто не го показвай на прясна вода.',
...

  {
    ...
    description: {
      ...
      bg: 'Армиите пропиляха тази дрънкулка, но все пак изглеждат безполезни за вас ...',
...

  {
    ...
    description: {
      ...
      bg: 'Хората джуджета и елфите притежават този артефакт, който го предава на поколения воини-ловци и големи бойни лидери.',
...

  {
    ...
    description: {
      ...
      bg: 'Вашите врагове халюциниращо състояние на ума, предизвикано от тази дрънкулка, позволяват вашите хитроумни удари да станат истински.',
...

  {
    ...
    description: {
      ...
      bg: 'Дълбоките тъмносини талисмани проследяват модели в душата ви, подсилвайки възстановяването и обновяването на света на безсмъртието.',
