export default [
  {
    ...
    description: {
      ...
      ph: 'Masama ang mga balsamo Siguro kung bakit mo pa ito napili.',
...

  {
    ...
    description: {
      ...
      ph: 'Ang plato ng balikat ng ilang mga nilalang ay umaakma rin bilang portable na kagamitan sa pagkain.',
...

  {
    ...
    description: {
      ...
      ph: 'Malakas ang kuwintas na smoothed at pinakintab upang bulag ka sa panahon ng labanan.',
...

  {
    ...
    description: {
      ...
      ph: 'Isang malungkot na pagkain mula sa mga huling taon ng ani.',
...

  {
    ...
    description: {
      ...
      ph: 'Ang manipis na slice ng granite ay perpekto para sa nagba-bounce sa mga ripples ng lawa.',
...

  {
    ...
    description: {
      ...
      ph: 'Sinabi ni Shimmering na telang pilak na ninakaw mula kay Aphrodite.',
...

  {
    ...
    description: {
      ...
      ph: 'Malamig at bughaw ang palawit ay nakawin ang iyong init bilang isang pagbabayad para sa mga epekto nito ...',
...

  {
    ...
    description: {
      ...
      ph: 'Nakakagulat na hindi ito amoy tulad ng isda. Lamang huwag ipakita ito freshwater.',
...

  {
    ...
    description: {
      ...
      ph: 'Ang mga hukbo ay nag-expire sa trinket na ito pero tila walang halaga sa iyo ...',
...

  {
    ...
    description: {
      ...
      ph: 'Pag-aari ng mga dwarf at elf ng mga tao ang artipisyal na ito na nagpapasa ito sa mga henerasyon ng mga mandirigmang mangangaso at mahusay na mga lider ng labanan.',
...

  {
    ...
    description: {
      ...
      ph: 'Mabigat ang mga weave ng mithril na nakasalalay sa makapangyarihang magic na pinupuno sa iyo ng isang mahiwagang enerhiya na nadarama ng ilan sa mga nabubuhay sa mundong ito.',
...

  {
    ...
    description: {
      ...
      ph: 'Ang mga mahiwagang anino ay umiiwas sa mga blades ng katotohanan na nagbibigay sa iyo na umalis sa iyong mga kaaway na napakapangit na mga pangarap.',
...

  {
    ...
    description: {
      ...
      ph: 'Ang iyong mga kaaway na nagpapahiwatig ng pag-iisip ng estado ng pag-iisip na dala ng panit na ito ay nagpapahintulot sa iyong mga tuso na paghampas na maging totoo.',
...

  {
    ...
    description: {
      ...
      ph: 'Malalim na madilim na kulay asul na alimasag pattern ng pagsunod sa iyong kaluluwa reinforcing muling pagtatayo at renovating para sa mundo ng imortalidad.',
