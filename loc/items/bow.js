export default [
  { // T1 item name. names are english only!
    ...
    description: {
      ...
      pt: 'Quase leve. Você pode provavelmente encontrar algo melhor nos arredores.',
...

  {
    ...
    description: {
      ...
      pt: 'O que é isso? É gelo? O mundo pode nunca vir a descobrir...',
...

  {
    ...
    description: {
      ...
      pt: 'Rodeado por uma aura medonha. O vento sopra na direção que em você aponta.',
...

  {
    ...
    description: {
      ...
      pt: 'Embutido em uma raiva primária, seus inimigos tremem ao ver esta arma. Pew pew é a última coisa que eles vão ouvir.',
