export default [
  {
    ...
    description: {
      ...
      de: 'Weich, voller Löcher. die Pfeile fallen immer wieder heraus.',
...

  {
    ...
    description: {
      ...
      de: 'Leinensack mit steifem überzogenem Leder.',
...

  {
    ...
    description: {
      ...
      de: 'Fein angefertigter Köcher aus geheimnisvollen schimmernden Material.',
...

  {
    ...
    description: {
      ...
      de: 'Zerbröckelte Schriftrollen, die mit Blut befleckt sind, man sagt dass das Chaos den Geist derer erfüllt, die von Pfeilen berührt wurden, die in einem solchen Köcher gehalten werden.',
