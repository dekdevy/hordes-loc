export default [
  {
    ...
    description: {
      ...
      ph: 'Moist ball ng lupa na umaalis sa likod ng mga maliliit na critters sa iyong kamay.',
...

  {
    ...
    description: {
      ...
      ph: 'Buzzing sticky pugayan ang paghahatid ng isang pangit na kagat bawat ngayon at pagkatapos.',
...

  {
    ...
    description: {
      ...
      ph: 'Matapos ang isang matigas na labanan habang ang pagnanakaw ng isang buto ng isang aso ay nagpasya kang itago ito bilang souvenir na nagpapaalala sa iyo ng iyong mga pakikibaka.',
...

  {
    ...
    description: {
      ...
      ph: 'Ang maliit na metal ball ay makintab at makinis na may ilang mga dents sa ibabaw nito.',
...

  {
    ...
    description: {
      ...
      ph: 'Ang mga sinag ng liwanag ay nahuli sa larangan na ito sa pagbubuhos ng magagandang mga ulan sa paligid mo.',
...

  {
    ...
    description: {
      ...
      ph: 'Ang sinaunang cyclops terrorizing mga lupang ito ay sa wakas ay pinatay na nagbibigay-daan sa iyo upang scavenge ang mabangong souvenir.',
...

  {
    ...
    description: {
      ...
      ph: 'Ang ilang mga mages ay gumagamit ng mga kawani ng ilang mga libro na nagpasya kang gumamit ng frozen na kumpol ng niyebe.',
...

  {
    ...
    description: {
      ...
      ph: 'Ang makislap at kaakit-akit na mahiwagang globo na ito ay gumagawa ng hangin sa paligid ng yelo na malamig.',
...

  {
    ...
    description: {
      ...
      ph: 'Ang enigmatic emerald green glove ay napapalibutan sa mga magagandang ukit ng mga serpentine prophecies nakakaakit ng katanyagan at serendipity sa kanyang walang muwang bearer.',
...

  {
    ...
    description: {
      ...
      ph: 'Transparent yellow tinged globe revealing nakulong infernal na mga puki ng paranormal aura na bumubulusok sa mga isipan ng mahihina sa mga plano ng lason at pagpatay.',
...

  {
    ...
    description: {
      ...
      ph: 'Maputlang asul na nakagagawa ng artipisyal na nagpapaikut-ikot na mga pulsing alon ng liwanag na naglalaho sa madilim na mga anino ng mga diyablo na kaluluwa mula sa iyong landas patungo sa kaluwalhatian.',
...

  {
    ...
    description: {
      ...
      ph: 'Inihaw ng laman at dugo ang globo na ito sa mga kaluluwa ng slain na lumilikha ng isang madilim na pulang kakanyahan na naka-embed sa sarili nito na nagbibigay sa iyo ng walang kapararakan na kasakiman para sa dugo at labanan.',
...

  {
    ...
    description: {
      ...
      ph: 'Ang madilim na nakamamatay at demonyo ay isang globo na nakabitin sa maliliit na mga kawit na puno ng mga pulang hiyas na nagtutulak ng mga takot ng takot sa mga taong tutol sa iyo.',
