export default [

  {
    ...
    description: {
      ...
      sv: 'En grotesk röra av ben som ger den vidskeplige tur.',
...

  {
    ...
    description: {
      ...
      sv: 'Ljusstrålar fångas i denna sfär och skapar vackra regnbågar runtomkring dig.',
...

  {
    ...
    description: {
      ...
      sv: 'En uråldrig cyklop som hade terroriserat dessa marker dödades till slut, och du fick en sällsam souvenir.',
...

  {
    ...
    description: {
      ...
      sv: 'Gåtfull smaragdgrön sfär, inramad i utsökt graverade lömska profetior som vilseleder dess bärare med löften om ära och berömmelse.',
