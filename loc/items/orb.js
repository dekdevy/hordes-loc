export default [
...

  {
    name       : {$$: 'Polished Bone' },
    description: {
      en: 'After a tough fight while robbing a bone of a dog, you decided to keep this as a souvenier reminding you of your struggles.'
    }
  },
...

  {
    name       : {$$: 'Glaedr' },
    description: {
      en: 'Pale blue faceted artifacted, radiating pulsing waves of light, banishing the dark shadows of demonic souls from your path to glory.'
    }
  },

  {
    name       : {$$: 'Mordhr' },
    description: {
      en: 'Flesh and blood enfused this orb with the souls of the slain, creating a dark red essence embeded in itself, granting you unprecedented lust for blood and battle.'
    }
  },
