export default [
  {
    ...
    description: {
      ...
      ru: 'Выжженные скрученные материалы из леса образуют амулет слабой защиты. Создание таких простых амулетов было популярной тактикаы выжевания в древних времен',
