export default [
  {
    ...
    description: {
      ...
      ph: 'Nakasira na ang kalahati nito at ginagamit mo pa rin ito?',
...

  {
    ...
    description: {
      ...
      ph: 'Ito ay dapat na pagmamartilyo mga kuko hindi skulls.',
...

  {
    ...
    description: {
      ...
      ph: 'Rusty lumang martilyo sa gilid ng paglabag.',
...

  {
    ...
    description: {
      ...
      ph: 'Sinusunod ni Orcs ang manghuhula ng kaunting armas na ito. Nito medyo walang silbi ngunit mukhang gusto nila ito ...',
...

  {
    ...
    description: {
      ...
      ph: 'Malaking sandata na ginamit sa mga sinaunang beses upang gumuho sa skulls.',
...

  {
    ...
    description: {
      ...
      ph: 'Strange rod-like basher. Mukhang krudo at nagpapalabas ng isang malabong amoy ng mga langis na druga ...',
...

  {
    ...
    description: {
      ...
      ph: 'Inilaan ng mga sinaunang dwarf ang makapangyarihang istraktura na ito. Madilim at nakamamatay.',
...

  {
    ...
    description: {
      ...
      ph: 'Ang mga mata ng mga diyos sundin ang wielder nagdadala ng kapalaran sa magiting at tadhana sa duwag.',
...

  {
    ...
    description: {
      ...
      ph: 'Ang Banal na tool na ginagamit ng mga druid upang gumawa ng mga sakripisyo sa sinaunang mga diyos ng kalikasan.',
...

  {
    ...
    description: {
      ...
      ph: 'Malakas na basher na ginagamit ng mga mandirigmang dwarven. Ginawa ng isang hindi kilalang metal na madilim at mabigat.',
...

  {
    ...
    description: {
      ...
      ph: 'Peke na walang init kills walang awa.',
...

  {
    ...
    description: {
      ...
      ph: 'Nangunguna sa bungo ng isang slain enemy behemoth ang armas na ito ay nagbigay inspirasyon sa terorismo sa lahat ng tumayo laban dito.',
...

  {
    ...
    description: {
      ...
      de: 'Mit dem Schädel eines getöteten Riesenfeindes überzogen, inspiriert diese Waffe Schrecken bei allen, die sich dagegen stellen.',
      fr: 'Surmontée du crâne d\'un ennemi géant assassiné, cette arme inspire la terreur à tous ceux qui s\'y opposent.',
      ph: 'Maaari bang tumagos ang iyong mahinang bungo na medyo madali. O iyong mga kaaway. Marahil sa iyo kahit na.',
...

  {
    ...
    description: {
      ...
      ph: 'Wala nang uri tungkol sa malupit na sandata na ito.',
...

  {
    ...
    description: {
      ...
      ph: 'Ang ilang mga sinasabi nito ginawa ng mga dwarves iba sabihin ng elves ... ang katotohanan ay pa na natuklasan.',
...

  {
    ...
    description: {
      ...
      ph: 'Mayroon ba itong kapangyarihan upang tapusin ang mga mundo? Ang ilang mga maaaring sabihin. Kung hindi namin mabubuhay nang mahaba upang malaman ito.',
...

  {
    ...
    description: {
      ...
      ph: 'Isang misteryosong salamangkero ang nagbabadya ng maraming malalim na mga kaakit-akit sa armas na ito na nagdadala ng malupit na mga kaisipan at mga pangarap sa wielder nito.',
