export default [
  {
    ...
    description: {
      ...
      de: 'Es ist fast zerbrochen, und du benutzt es immer noch?',
...

  {
    ...
    description: {
      ...
      de: 'Rostiger alter Hammer, er ist kurz davor zu brechen.',
...

  {
    ...
    description: {
      ...
      de: 'Seltsamer stabförmiger Schläger. Sieht roh aus, es hat einen leichten hauch von Druidenölen...',
...

  {
    ...
    description: {
      ...
      de: 'Man sagt, dass die Augen der Götter dem Träger folgen, sie bringen den Mutigen Glück und stürzen die Feiglinge ins Verderben.',
...

  {
    ...
    description: {
      ...
      de: 'Diese Waffe, ist mit dem Schädel eines getöteten Tieres überzogen, sie weckt Schrecken bei allen, und jedem der sich dagegen stellt.',
...

  {
    ...
    description: {
      ...
      de: 'Mit dem Schädel eines getöteten Riesenfeindes überzogen, diese Waffe inspiriert Schrecken bei allen, die sich dagegen stellen.',
...

  {
    ...
    description: {
      ...
      de: 'Ein Mysteriöser Magier, der mit vielen komplizierten Reizen auf dieser Waffe verewigt ist und schreckliche Gedanken und Träume zu seinem Besitzer bringt.',
