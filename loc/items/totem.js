export default [
  {
    name       : {$$: 'Herb Bundle' },
    description: {
      en: 'A wad of herbs tied together by a thin piece of yarn.',
      ro: 'O mână de iarbă legată împreună cu un fir subțire de ață',
      ...
      fr: 'Une poignée de brins d\'herbes liés entre eux par un mince morceau de laine.',
      ...
      sv: 'En lappa av örter bundet samman med en tunn bit garn.',
      de: 'Ein Bündel von Kräutern, die durch ein dünnes Stück Garn miteinander verbunden sind.'
    }
  },

  {
    ...
    description: {
      ...
      fr: 'Des brindilles fines et enchevêtrées vous griffent les mains pendant que vous les transportez avec vous.',
      ...
      sv: 'Tunna tunna tiggar kliar dina händer när du bär den runt.',
      de: 'Verworrene dünne Zweige kratzen an den Händen, während du sie herumträgst.'
    }
  },

  {
    ...
    description: {
      ...
      fr: 'Une sculpture en pierre particulière, lisse à cause des martèlements du temps.',
      ...
      sv: 'En märklig stenhuggning, slät från tidens bultar',
      de: 'Eine eigentümliche Steinmetzarbeit, glatt von den Schlägen der Zeit.'
    }
  },

  {
    name       : {$$: 'Divine Bone' },
    description: {
      en: 'An ancient bone, etched with scenes of battle and hunting.',
      ro: 'Un os străvechi, gravat cu scene de luptă și vânătoare.',
      ...
      sv: 'Ett gammalt ben, etsat med scener av strid och jakt.',
      de: 'Ein alter Knochen, geätzt mit Szenen von Kampf und Jagd.'
    }
  },

  {
    name       : {$$: 'Celestial Fetish' },
    description: {
      en: 'Pure white marble rod encased in a soft yellow glow filling your hands with a divine spiritual light.',
      ro: 'O tijă de marmură albă, pură, încastrată într-o licărire blândă și galbenă, îți umple mâinile cu o lumină spirituală divină.',
      ...
      ru: 'Палочка из чистого белого мрамора, заключенная в мягкое желтое сияние, наполняет ваши руки божественным душевным светом.',
      ...
      sv: 'Ren vit marmorstång omslagen i en mjuk gul glöd som fyller dina händer med ett gudomligt andligt ljus.',
      de: 'Reinweißer Marmorstab, umhüllt von einem weichen gelben Licht, das Ihre Hände mit einem göttlichen spirituellen Licht erfüllt.'
    }
  },

  {
    name       : {$$: 'Glade' },
    description: {
      en: 'An eagle, noble and valiant, carved from the holy wood of an ancient tree.',
      ro: 'Un vultur, nobil și viteaz, sculptat din lemnul Sfânt al copacilor antici.',
      ...
      sv: 'En örn, ädla och tapper, snidade från ett gammalt träds heliga trä.',
      de: 'Ein Adler, edel und tapfer, geschnitzt aus dem heiligen Holz eines alten Baumes.'
    }
  },

  {
    ...
    description: {
      ...
      de: 'Die Macht der mysteriösen Wasserdämonen folgt deinen Schritten, während du den Weg auf dem dunklen Pfad der unbekannten Wunder gehst.'
    }
  },

  {
    ...
    description: {
      ...
      fr: 'Déchiré des motifs d\'une dimension, ce totem démoniaque submerge les esprits frêles de vos ennemis sous un nuage de désarrois atroces.',
      ...
      de: 'Dieses dämonische Totem, das aus den Mustern einer Dimension gerissen wurde, taucht den zerbrechlichen Verstand deiner Feinde in eine Wolke schrecklicher Verwirrung.'
    }
  },

  {
    name       : {$$: 'Howl' },
    description: {
      en: 'An eerie carving of a grim wolf sometimes casting a soft howl-like whisper into the murmurs of the night.',
      ro: 'O sculptură sinistră a unui lup necruțător, ce uneori scoate un urlet moale ca o șoaptă în murmurul nopții întunecate.',
      ...
      de: 'Eine unheimliche Schnitzerei eines grimmigen Wolfes, der manchmal ein leises heulendes Flüstern in die Murmeln der Nacht wirft.'
    }
  },

  {
    name       : {$$: 'Brethiza' },
    description: {
      en: 'Wind and spirit go hand in hand, trapping you in their swift path through the deep valleys of divinity and enlightenment.',
      ro: 'Vântul și spiritul merg mână în mână, prinzându-te în calea lor rapidă prin văile adânci ale divinității și iluminismului.',
      ...
      fr: 'Le vent et l\'esprit vont de pair, vous piégeant dans leur rapide route à travers les profondes vallées de la divinité et de l\'illumination.',
      ...
      de: 'Wind und Geist gehen Hand in Hand und fangen dich auf ihrem schnellen Weg durch die tiefen Täler der Göttlichkeit und Erleuchtung ein.'
    }
  }
