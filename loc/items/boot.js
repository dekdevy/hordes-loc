export default [
  {
    ...
    description: {
      ...
      ph: 'Hindi bababa sa ikaw ay may suot ng isang bagay sa mga paa.',
...

  {
    ...
    description: {
      ...
      ph: 'Ang mga solong gawa sa tela ay malamang na mapunit pagkatapos ng ilang oras.',
...

  {
    ...
    description: {
      ...
      ph: 'Ang malambot na katad ay sinasabing hinubaran ng mga ligaw na baboy na nakasisilaw sa nakatatakot na mga kahoy.',
...

  {
    ...
    description: {
      ...
      ph: 'Maliwanag na kulang sa imahinasyon ang gumagawa ay gumawa ng mga bota mula sa mga buto ng isang napakalaking nilalang ...',
...

  {
    ...
    description: {
      ...
      ph: 'Ang mga mahiwagang kaliskis ay sumasaklaw sa labas ng iyong kasuotan sa paa nakahahalina glares sa araw.',
...

  {
    ...
    description: {
      ...
      ph: 'Isang maayang pattern na ginawa upang maparalisa ang iyong mga kaaway ... magtaka kung ito gumagana.',
...

  {
    ...
    description: {
      ...
      ph: 'Kinuha mula sa mga beterano ng digmaan na malinaw na hindi nakahanap ng sapat na proteksyon mula sa mga ito.',
...

  {
    ...
    description: {
      ...
      ph: 'Chunky sa kanyang hitsura marahil napaka hindi komportable.',
...

  {
    ...
    description: {
      ...
      ph: 'Magpatakbo nang mabilis hangga\'t ang hangin ... o malapit dito.',
...

  {
    ...
    description: {
      ...
      fr: 'Forgé sans chaleur, fonctionne sans tomber.',
      ...
      ph: 'Peke na walang init ay tumatakbo nang hindi marapa.',
...

  {
    ...
    description: {
      ...
      ph: 'Ang ilang mga sinasabi maaari kang tumakbo sa mga ulap sa mga ito. Ang ilang mga na sinubukan ay umakyat na.',
...

  {
    ...
    description: {
      ...
      ph: 'Ang sinaunang bota na rumored na ninakaw mula sa mga paa ng diyos ng sugo ng Romano ...',
...

  {
    ...
    description: {
      ...
      ph: 'Ang mga bituin ay palaging itinuturing na pinakamakapangyarihan ngayon sila ay iyo.',
