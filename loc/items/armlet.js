export default [
...

  {
    ...
    description: {
      ...
      ko: '이 팔보호구는 성급하게 만들어졌습니다. 가죽에 새겨진 격한 싸움의 자국을 보니 전 주인의 생사여부를 확신할순 없겠군요.',
...

  {
    ...
    description: {
      ...
      pl: 'Twarda skóra została dokładnie przerobiona na porządne opaski. Na boku skóry podpisał się twórca: "Markay\'ak.',
      ...
      ko: '힘든 제작 끝에 가죽 팔보호구가 꽤 괜찮은 팔보호구가 되었습니다, 팔보호구 구석에 장인의 서명이 있군요: "Markay\'ak".',
...

  {
    ...
    description: {
      ...
      ko: '이 팔보호구는 몬스터의 두꺼운 뼈로 만들어집니다. 내려온 미신에 의하면 이런 팔보호대를 착용하는 사용자의 몸에 몬스터의 힘이 일부 스며들것이라는 이야기가 있습니다, 그러나 다른 사람들은 뼈를 재사용하는것이 몬스터의 부활을 방지한다고 주장합니다.',
...

  {
    ...
    description: {
      ...
      ko: '이런 철로 만들어진 팔보호구는 전쟁에 사용되고 더러워집니다. 철에 새겨진 발톱자국이 그렇게 깊지는 않아보이는군요.',
...

  {
    ...
    description: {
      ...
      ko: '이 마력의 팔보호구에는 방어력을 위한 작은 룬이 넣어져있습니다. 이 팔보호구에 들어가있는 룬의 출처가 어딘지 모르기에 이 팔보호구는 희귀합니다.',
...

  {
    ...
    description: {
      ...
      ko: '이 팔보호대는 마법으로만 만들수있는 특별한 불로 만들어졌습니다, 과거에는 소수의 엘리트 장인들만이 화염 팔보호구를 만드는 비법을 알았습니다.',
...

  {
    ...
    description: {
      ...
      ko: '반사의 팔보호구는 전문적인 장인들이 적의 공격을 반사하여 데미지를 감소시키는 팔보호구이다. 이 방어력은 많은 엘비쉬의 마법사들에게 감명을주었고, 그들은 반사의 로 많은 실험을 했다.',
...

  {
    ...
    description: {
      ...
      ko: '골렘의 파편은 소수의 마법을 사용하는 장인들이 뭉쳐서 만들었다. 모든 골렘의 파편은 골렘의 껍질을 이용하여 수백일에 걸쳐서 만들어졌다.',
...

  {
    ...
    description: {
      ...
      ko: '이런 팔보호구는 산에서 발견되는 희귀한 철로 만들어진다. 장인들은 마법부여를 극대화 하기위해 열이 아닌 마법의 망치로 팔보호구를 만들었다.',
...

  {
    ...
    description: {
      ...
      ko: '이 팔보호구는 장인이 조각한 흑운석으로 만들어졌다. 2차 대전쟁이라는 대재앙 이후 많은 양의 흑운석이 발견되었다.',
...

  {
    ...
    description: {
      ...
      ko: '야망이 있는 미친 과학자들이 다른 차원의 마법을 사용하여 일반 팔보호구를 초월한 다른차원의 팔보호구를 만드는 방법을 알아냈다. 이 엄청난 팔보호구는 특정한 모양으로 만들어져야 본래의 힘을 사용할수 있다.',
...

  {
    ...
    description: {
      ...
      ko: '몇몇 전설들은 이 팔보호구는 이 차원에 보호가 필요할때 나타난다고 한다. 과거의 기록을 보면 가디언즈라는 이름의 팔보호구가 나타날때마다 끔직한 재앙이 일어났다고 한다, 그러하여 가디언즈가 나타날때마다 그것은 불길한 징조로 여겨진다.',
