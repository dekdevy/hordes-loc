export default [
...

  {
    ...
    description: {
      ...
      ru: 'Эльфы сделали это кольцо, чтобы защитить себя от опасности.',
      es: 'Los elfos hicieron este anillo para protegerse del peligro.',
      de: 'Die Elfen bauten diesen Ring, um sich vor Gefahren zu schützen.',
      hi: 'कल्पित बौनों ने खुद को खतरे से बचाने के लिए यह अंगूठी बनाई।',
      fr: 'Les elfes ont fabriqué cet anneau pour se protéger du danger.',
      pt: 'Os elfos fizeram este anel para se protegerem do perigo',
      tl: 'Ginawa ng mga elf ang ring na ito upang protektahan ang kanilang sarili mula sa panganib',
      bg: 'Елфите направиха този пръстен, за да се предпазят от опасност.',
      el: 'Τα ξωτικά έκαναν αυτό το δαχτυλίδι για να προστατευτούν από τον κίνδυνο',
      nl: 'De elfen maakten deze ring om zich te beschermen tegen gevaar.',
      pl: 'Elfy stworzyły ten pierścień, aby chronić się przed niebezpieczeństwem.',
      it: 'Gli elfi hanno creato questo anello per proteggersi dal pericolo',
