export default [
  { // T1 item name. names are english only!
    ...
    description: {
      ...
      ph: 'Sinasabi ng lahat ng pangalan. Mag-ingat sa mga splinters.',
  ...
  { // T2 item
    ...
    description: {
      ...
      ph: 'Hindi mas mahusay kaysa sa isang mapurol piraso ng kahoy sa aking opinyon.',
  ...
  { // T3 item
    ...
    description: {
      ...
      ph: 'Ako ba ay pranked?',
      bg: 'Аз ли съм шегуван?',
      el: 'Είμαι φάρσα;',
  ...
  { // T4 item
    ...
    description: {
      ...
      ph: 'Bumagsak ito ng ilang kabalyero. Marahil hindi sinasadya.',
      bg: 'Някой рицар се отказа от това. Вероятно неволно.',
  ...
  { // T5 item. names are english only!
    ...
    description: {
      ...
      ph: 'Matagal? Oo. Nakamamatay? Siguro. Huwag lamang i-cut ang iyong sarili.',
      bg: 'Long? Да. Deadly? Може би. Просто не се режете.',
  ...
  { // T6 item
    ...
    description: {
      ...
      ph: 'Crudely inukit mula sa mga buto ng isang sinaunang behemoth.',
  ...
  { // T7 item
    ...
    description: {
      ...
      ph: 'Isang tabak kaya makapangyarihan na ilang maaaring hawakan ito. Napakaganda nito.',
      bg: 'Толкова могъщ меч, че малцина могат да се справят с него. Нейната доста тежка.',
  ...
  { // T8 item
    ...
    description: {
      ...
      ph: 'Diabolical curved blade. Kahit na humahawak ito ginagawang pakiramdam mo ang madilim na kakanyahan.',
      bg: 'Дяволско извито острие. Дори да го държите, ще почувствате неговата тъмна същност.',
  ...
  { // T9 item
    ...
    description: {
      ...
      ph: 'Isang malamig na nakikitang talim na may nasusunog na hot slice.',
      bg: 'Студено изглеждащо острие с горещо парче.',
      el: 'Μια λεπίδα με κρύα εμφάνιση με καυτή φέτα.',
      ...
      ro: 'O lamă cu aspect rece, cu o tăietură ce arde.'
    }
  },
  ...
  { // T10 item
    ...
    description: {
      ...
      ph: 'Ang isang talim na ginagamit lamang ng mga pinaka-mahusay na Knights.',
  ...
  { // T11 item
    ...
    description: {
      ...
      ph: 'Ninakaw na tabak na ninakaw mula sa isang sinaunang hari. Ang pagputol ng kakayahan ay kaduda-dudang.',
  ...
  { // T12 item
    ...
    description: {
      ...
      ph: 'Makapangyarihang obra maestra na dinala mula sa abysses ng underworld.',
  ...
  { // T13 item
    ...
    description: {
      ...
      ph: 'Mahiwagang pink na tabak. Engravings sabihin "Mächtig Zerstörer".',
  ...
  { // T14 item
    ...
    description: {
      ...
      ph: 'Nagmumula ng tisyu na nabubuhay habang nilusob nito ang makapal na kalamnan ng iyong mga kaaway na matalo ang puso.',
      bg: 'Поглъща жива тъкан, тъй като потъва в гъстата мускулатура на враговете ви, биеща сърцето.',
  ...
  { // T15 item
    ...
    description: {
      ...
      ph: 'Maaari itong magputol ng mga demonyo ngunit hindi mga anghel.',
      bg: 'Тя може да отреже демони, но не и ангели.',
  ...
  { // T16 item
    ...
    description: {
      ...
      ph: 'Sinabihan kami na mahila ito mula sa bato. Hindi pa rin mahanap ang bato.',
  ...
  { // T17 item
    ...
    description: {
      ...
      ph: 'Ang armas na ito ay nagdudulot ng pagdating ng isang bagong edad.',
