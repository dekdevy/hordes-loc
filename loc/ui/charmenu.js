export default {
  ...
  create: {
    ...
    pressIcon: {
      ...
      es: 'Presione un icono para obtener una breve descripción.',
    ...
    nameReq: {
      ...
      es: 'Su nombre sólo puede contener caracteres de la a-Z, y números del 0-9, sin espacios. Entre 3 y 16 caracteres.',
