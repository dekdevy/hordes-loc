export default {
  ...
  create: {
    ...
    nameReq: {
      ...
      bg: 'Вашето име може да съдържа само знаци a-Z и числа 0-9 без интервали. До 16 знака.',
      el: 'Το όνομά σας μπορεί να περιέχει μόνο χαρακτήρες a-Z και αριθμούς 0-9 χωρίς κενά. Έως 16 χαρακτήρες.',
  ...
  delete: {
    ...
    info: {
      ...
      ph: 'Upang tanggalin ang uri ng pangalan ng mga character. Ang iyong karakter ay hindi maibabalik.',
      bg: 'За да изтриете въведете името на символите. Вашият герой не може да бъде възстановен.',
      el: 'Για να διαγράψετε, πληκτρολογήστε το όνομα χαρακτήρων. Ο χαρακτήρας σας δεν μπορεί να αποκατασταθεί.',
