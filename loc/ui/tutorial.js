...
export default {
  msg: [
    ...
    {en: 'You can press SHIFT to scan the ground for items. Find an item! (not gold)'},
    ...
    {en: 'Invite players to your party by right-clicking on their unitframe, or use the command /partyinvite.'},
