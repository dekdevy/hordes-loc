...
export default {
  msg: [
    { // _TUT_MOVE
      ...
      pt: 'Bem-vindo! Pressione <kbd>W A S D</kbd> ou <kbd>⭠ ⭢ ⭡ ⭣</kbd> para mover-se.',
      sr: 'Добродошао! Притисни <kbd>W A S D</kbd> или <kbd>⭠ ⭢ ⭡ ⭣</kbd> за кретање.'
    },
    { // _TUT_CAMERA
      ...
      pt: 'Ótimo! Agora, <kbd>clique esquerdo/direito</kbd> e arraste o mouse para girar a câmera.',
      sr: 'Одлично! Сада држи <kbd>леви/десни клик</kbd> и превуци миш да окренеш камеру.'
    },
    { // _TUT_UISELECTUNIT
      ...
      pt: 'Avance e encontre um monstro, depois mire nele clicando com o mouse ou pressionando <kbd>TAB</kbd>.',
      sr: 'Иди напред и пронађи чудовиште, па га означи кликом миша или притиском на <kbd>TAB</kbd>.'
    },
    { // _TUT_CASTSPELL
      ...
      pt: 'Você pode atacar pressionando as teclas na sua barra de habilidades. Pressione <kbd>1</kbd> no seu teclado para atacar o monstro!',
      sr: 'Можеш да нападнеш притиском на тастере у свом skillbar-у. Притисни <kbd>1</kbd> на тастатури да нападнеш чудовиште!'
    },
    { // _TUT_KILLMOB
      ...
      pt: 'Perfeito! Continue assim e derrote o monstro!',
      sr: 'Савршено! Само тако настави и среди чудовиште!'
    },
    { // _TUT_EXPREWARD
      en: 'Nice job. You have been rewarded with experience points.',
      fr: 'Bien joué. Tu as été récompensé com des points d\'expérience.',
      es: 'Buen trabajo. Has ganado puntos de experiencia.',
      pt: 'Bom trabalho. Você foi recompensado com pontos de experiência.',
      sr: 'Лепо одрађено. Добио си поене искуства.'
    },
    { // _TUT_EXPINFO
      ...
      sr: 'Скупи довољно поена искуства и подићи ћеш ниво.'
    },
    { // _TUT_FINDITEM
      ...
      sr: 'Можеш да притиснеш <kbd>Shift</kbd> да видиш предмете и новчиће на земљи. Покупи један предмет!'
    },
    { // _TUT_OPENBAG
      ...
      sr: 'Покупио си предмет. Отвори инвентар (<kbd>B</kbd>) да га видиш.'
    },
    { // _TUT_BAGMEME
      ...
      sr: 'Овде можеш да видиш своје предмете. Величина инвентара зависи од торбе коју носиш.'
    },
    { // _TUT_EQUIPITEM
      ...
      pt: 'Você pode equipar itens clicando com o botão direito neles e selecionando "Equipar item".',
      sr: 'Предмете можеш да опремиш десним кликом на њих и избором "Опреми предмет".'
    },
    { //  _TUT_OPENCHARPANEL
      ...
      pt: 'Abra seu painel de personagem (<kbd>C</kbd>).',
      sr: 'Отвори панел свог лика (<kbd>C</kbd>).'
    },
    { // _TUT_CHARPANELINFO
      ...
      pt: 'Você pode ver todos os itens equipados no seu painel de personagem.',
      sr: 'На панелу свог лика можеш да видиш сву опрему коју носиш.'
    },
    { // _TUT_GOLEVELUP
      ...
      pt: 'Agora, tente subir de nível matando monstros.',
      sr: 'Сада покушај да подигнеш ниво убијањем чудовишта.'
    },
    { // _TUT_OPENCHARPANEL2
      en: 'You have leveled up and earned stat points. Open your character panel (<kbd>C</kbd>) again.',
      fr: 'Tu as mounted de niveau et gagné des points de stat. Ouvre à nouveau ton interface de personnage (<kbd>C</kbd>).',
      es: 'Has subido de nivel y has ganado puntos de estadísticas. Vuelve a abrir el panel de tu personaje (<kbd>C</kbd>).',
      pt: 'Você subiu de nível e ganhou pontos de atributo. Abra seu painel de personagem (<kbd>C</kbd>) novamente.',
      sr: 'Подигао си ниво и добио поене за атрибуте. Поново отвори панел лика (<kbd>C</kbd>).'
    },
    { //  _TUT_USESTATPOINTS
      ...
      pt: 'Os pontos de atributo podem ser usados para aumentar seus atributos principais. Passe o mouse sobre os botões para visualizar seus efeitos e então use seus pontos de atributo.',
      sr: 'Поени за атрибуте служе за повећање главних статистика. Пређи мишем преко дугмади да видиш ефекте, па потроши поене.'
    },
    { // _TUT_LEVELUPTONEWSKILL
      ...
      pt: 'Agora, vamos ensinar você a aprender novas habilidades. Primeiro, suba para o nível 3 para desbloquear uma nova habilidade.',
      sr: 'Сада ћемо те научити како да откључаш нове вештине. Прво стигни до нивоа 3 да откључаш нову вештину.'
    },
    { // _TUT_NEWSKILLEXPLANATION
      en: 'A new skill is available. You need to use books to learn new skills.',
      fr: 'Une nouvelle compétence est disponible. Tu dois utiliser des livres pour aprender de nouvelles compétences.',
      ...
      sr: 'Нова вештина је доступна. За учење нових вештина потребне су ти књиге.'
    },
    { // _TUT_COLLECTBOOKCOINS
      ...
      pt: 'Colete alguns itens e moedas. Você precisa de 32 moedas para seu primeiro livro. Você também pode vender itens para o comerciante.',
      sr: 'Скупи мало предмета и новчића. За прву књигу треба ти 32 новчића. Предмете можеш и да продаш трговцу.'
    },
    { // _TUT_VISITTRADER
      ...
      pt: 'Você tem moedas suficientes. Volte para sua base e fale com o comerciante da sua classe para comprar seu novo livro de habilidades.',
      sr: 'Имаш довољно новчића. Врати се у базу и разговарај са трговцем своје класе да купиш нову књигу вештина.'
    },
    { // _TUT_BUYSKILLBOOK
      ...
      sr: 'Трговац продаје књиге вештина, напитке и јахаче животиње. Кликни десним кликом на књигу да је купиш.'
    },
    { // _TUT_USETHEBOOK
      ...
      pt: 'Quando tiver o livro, abra seu inventário, clique com o botão direito no livro e pressione <kbd>Usar Item</kbd> para aprendê-lo.',
      sr: 'Када добијеш књигу, отвори инвентар, кликни десним кликом на књигу и притисни <kbd>Use Item</kbd> да је научиш.'
    },
    { // _TUT_OPENSKILLMENU
      ...
      pt: 'Feche a janela do Comerciante, depois abra seu painel de habilidades (<kbd>K</kbd>) para ver uma visão geral das suas habilidades.',
      sr: 'Затвори прозор трговца, па отвори панел вештина (<kbd>K</kbd>) да видиш преглед својих вештина.'
    },
    { // _TUT_HOVEROVERSKILLS
      ...
      pt: 'Aqui você pode ver suas habilidades. Passe o mouse sobre elas para obter informações adicionais. As habilidades geralmente requerem um ponto de habilidade, que você ganha a cada dois níveis.',
      sr: 'Овде можеш да видиш своје вештине. Пређи мишем преко њих за додатне информације. Вештине обично траже један поен вештине, који добијаш на свака два нивоа.'
    },
    { // _TUT_ADDSKILLPOINT
      ...
      pt: 'Você pode alterar sua configuração de habilidades a qualquer momento. Adicione um ponto de habilidade na sua habilidade para ativá-la.',
      sr: 'Свој распоред вештина можеш да промениш у било ком тренутку. Додај поен вештине да је активираш.'
    },
    { // _TUT_APPLYSKILLS
    ...
    { // _TUT_TEXT1
      ...
      pt: 'Você aprendeu muito. Você está quase pronto para começar sua aventura.',
      sr: 'Много тога си научио. Скоро си спреман да започнеш авантуру.'
    },
    { // _TUT_PARTYBUTTON
    ...
    { // _TUT_BOOKS_EXTRA_INFO
      ...
      sr: 'Савет: Све књиге вештина нивоа 1 могу да се купе код трговца твоје класе. Књиге вишег нивоа падају са чудовишта.'
    },
    { // _TUT_MERCHANT_INFO
      ...
      pt: 'Dica: Você pode negociar itens com outros jogadores. Você pode visitar o Comerciante para fazer isso. Ele usa um grande chapéu verde.',
      sr: 'Савет: Можеш да тргујеш предметима са другим играчима. За то посети Merchant-а. Носи велики зелени шешир.'
    },
    { // _TUT_MERCHANT_STASH
      ...
      pt: 'Dica: Qualquer item que você comprar no comerciante será enviado para seu stash - um armazenamento para seus itens e ouro. É uma caixa marrom localizada ao lado do comerciante.',
      sr: 'Савет: Сваки предмет који купиш код Merchant-а биће послат у твој Stash - складиште за предмете и злато. То је браон кутија поред Merchant-а.'
    },
    { // _TUT_BLACKSMITH
      ...
      pt: 'Dica: Você encontrará runas ao matar monstros. As runas permitirão que você melhore seus itens. Visite o ferreiro para fazer isso.',
      sr: 'Савет: Рунe ћеш налазити убијањем чудовишта. Оне ти омогућавају да унапредиш предмете. За то посети ковача.'
    },
    { // _TUT_CHAT
    ...
    { // _TUT_SETTINGS
      ...
      pt: 'Dica: Pressione a engrenagem no canto superior direito para abrir as configurações. Você pode alterar controles, mensagens no chat, configurações de interface e gráficos.',
      sr: 'Савет: Притисни зупчаник у горњем десном углу да отвориш подешавања. Тамо можеш да мењаш контроле, поруке у чету, подешавања интерфејса и графику.'
    },
    { // _TUT_HELLSPAWN
    ...
    { // _TUT_HELLSPAWN2
      ...
      fr: 'Astuce: Les monstres de fin du jeu ayant un haut niveau d\'"Hellspawn" ont une chance de laisser tomber des familiers rares quand ils sont tués, lesquels peuvent être vendus à d\'autres jogadores.',
      ...
      pt: 'Dica: Monstros hellspawn de alto nível do endgame têm chance de dropar pets raros, que podem ser vendidos para outros jogadores.',
      sr: 'Савет: Hellspawn чудовишта високог нивоа у endgame-у имају шансу да испусте ретке љубимце, које можеш да продаш другим играчима.'
    },
    { // _TUT_OBELISK
      ...
      fr: 'Astuce: L\'Obélisque est un événement JcJ de fin de jeu qui dure 1 heure et se répétete toutes les 3 heures. Tu peux rendre visite au Conjurateur de Guerre pour te téléporter dans une bataille JcJ.',
      ...
      pt: 'Dica: O Obelisco é um evento PVP de endgame que dura uma hora e se repete a cada 3 horas. Você pode visitar o Conjurador de Guerra para se teletransportar para uma batalha PvP.'
    },
    { // _TUT_OBELISK2
      ...
      pt: 'Dica: Quando você vence uma luta do Obelisco, você recebe uma <kbd>Bênção dos Ossos</kbd>. Esse buff concede drops extras de chefes.'
    },
    { // _TUT_GLOOMFURY
    ...
    { // _TUT_MAXLEVEL
      ...
      pt: 'Parabéns pelo nível 45! Agora você pode se juntar a outros jogadores para lutar contra Gloomfury, fazer Obelisks PvP, farmar Hellspawn ou caçar pets e montarias raras!'
    }
  ]
}
