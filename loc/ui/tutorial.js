export default {
  guided: {
    ...
    talkQuestGiver: {
      ...
      de: 'Sprich mit dem Questgeber',
      ru: 'Поговори с квестодателем',
      zh: '與任務發布者交談',
      pt: 'Fale com o NPC da missão',
      es: 'Habla con quien da la misión',
      fr: 'Parle au donneur de quête',
      ro: 'Vorbește cu NPC-ul misiunii',
      it: 'Parla con chi dà la missione',
      nl: 'Praat met de questgever',
      vi: 'Nói với NPC giao nhiệm vụ',
      hu: 'Beszélj a küldetésadóval',
      cs: 'Promluv se zadavatelem úkolu',
      pl: 'Porozmawiaj ze zleceniodawcą'
    },
    acceptQuest: {
      en: 'Accept the quest',
      de: 'Quest annehmen',
