  ...
  msg: [
    {
      ...
      // tr: 'Hoşgeldin! Yürümek için <kbd>W A S D</kbd> veya <kbd>⭠ ⭢ ⭡ ⭣</kbd> tuşlarına bas.
    },
    {
      ...
      // tr: 'İyi iş çıkardın! Şimdi, <kbd>left/right click</kbd> ve fareni çevirerek kamerayı çevir.'
    },
    {
      ...
      // tr: 'Dövüşe hazır olman için sana ara yüzü açıklayacağım.'
    },
    {
      en: 'This is your unit frame. You can see your own health and mana here.',
      it: 'Questo è il telaio della tua unità. Puoi vedere la tua salute e il tuo mana qui.'
      ...
      // tr: 'Bu senin birim çerçeven. Canını ve mananı buradan görebilirsin.'
    },
    {
      ...
      // tr: 'İlerle ve bir canavar bul, sonra ona faren ile tıklayarak veya <kbd>TAB</kbd> tuşuna basarak hedef al.'
    },
    {
      en: 'This monster is now your target. Any spells you cast will be directed at your target.',
      it: 'Questo mostro è ora il tuo obiettivo. Tutti gli incantesimi che lanci saranno diretti al tuo bersaglio.'
      ...
      // tr: 'Bu canavar şimdi senin hedefin. Yaptığın her büyü bu hedefe uygulanacak.'
    },
    {
      en: 'You can attack by pressing the keys on your skillbar. Press <kbd>1</kbd> on your keyboard to attack the monster!',
      it: 'Puoi attaccare premendo i tasti sulla barra delle abilità. Premi <kbd>1</kbd> sulla tastiera per attaccare il mostro!'
      ...
      // tr: 'Yetenek çubuğunda ki tuşlara basark saldırabilirsin. <kbd>1</kbd> tuşuna basarak canavara saldır!'
    },
    {
      ...
      // tr: 'Harika! Bunu yapmaya devam et ve canavar ile uğraş!'
    },
    {
      en: 'Nice job. You have been rewarded with experience points.',
      it: 'Bel lavoro. Sei stato premiato con punti esperienza.'
      ...
      // tr: 'Harika iş. Deneyim puanı ile ödüllendirildin.'
    },
    {
      ...
      // tr: 'Yeterince deneyim puanı toplarsan seviye atlarsın.'
    },
    {
      en: 'You can press <kbd>Shift</kbd> to see items and coins on the ground. Pick up an item! ',
      it: 'Puoi premere <kbd>Maiusc</kbd> per vedere oggetti e monete a terra. Prendi un oggetto! '
      ...
      // tr: '<kbd>Shift</kbd> tuşuna basarak yerdeki eşyaları ve paraları görebilirsin. Topla onları!'
    },
    {
      en: 'You have picked up an item. Open your inventory (<kbd>B</kbd>) to see it.',
      it: 'Hai ritirato un oggetto. Apri il tuo inventario (<kbd>B</kbd>) per vederlo.'
      ...
      // tr: 'Bir eşya topladın. (<kbd>B</kbd>) tuşuna basarak envanterini aç.'
    },
    {
      en: 'Here you can see your items. The inventory size depends on the bag you have equipped.',
      it: 'Qui puoi vedere i tuoi articoli. La dimensione dell tuo inventario dipende dalla borsa che hai equipaggiato.'
      ...
      // tr: 'Burada eşyalarını görebilirsin. Envanterinin kapasitesi kuşanmış olduğun çantanın boyutuna bağlıdır.'
    },
    {
      en: 'You can equip items by right clicking them and selecting "Equip item".',
      it: 'Puoi equipaggiare gli oggetti facendo clic con il tasto destro su di essi e selezionando "Equipaggia oggetto".'
      ...
      // tr: 'Eşyalarına sağ tıklayıp "eşyayı kuşan" seçeneğiyle onları kuşanabilirsin.'
    },
    {
      en: 'Open your character panel (<kbd>C</kbd>).',
      it: 'Apri il pannello del tuo personaggio (<kbd>C</kbd>).'
      ...
      // tr: 'Karakter panelini aç (<kbd>C</kbd>).'
    },
    {
      en: 'You can see all equipped items in your character panel.',
      it: 'Puoi vedere tutti gli oggetti equipaggiati nel pannello del tuo personaggio.'
      ...
      // tr: 'Kuşanılmış tüm eşyalarını karakter panelinde görebilirsin.'
    },
    {
      en: 'Next, try to level up by killing monsters.',
      it: 'Benvenuto! Premi <kbd>W A S D</ kbd> o <kbd>⭠ ⭢ ⭡ ⭣</ kbd> per spostarti.'
      ...
      // tr: 'Sırada, canavarları öldürerek seviye atla'
    },
    {
      en: 'You have leveled up and earned stat points. Open your character panel (<kbd>C</kbd>) again.',
      it: 'Quindi, prova a salire di livello uccidendo mostri.'
      ...
      // tr: 'Seviye atlayıp istatistik puanı kazandın. Karakter panelini tekrar (<kbd>C</kbd>) tuşuna basarak aç.'
    },
    {
      ...
      it: 'I punti statistiche possono essere usati per aumentare le tue statistiche primarie. Passa il mouse sui pulsanti per visualizzare in anteprima i loro effetti, quindi usa i tuoi punti stat.'
      ...
      // tr: 'İstatistik puanları ana istatistiklerini arttırmak için kullanılır. Tuşların üzerinde durarak etkilerini ön izle, sonra istatistik puanlarını kullan.'
    },
    {
      en: 'Next, we will teach you how to learn new skills. First, level up to level 3 to unlock a new skill.',
      it: 'Successivamente, ti insegneremo come apprendere nuove abilità. Per prima cosa, sali di livello fino al livello 3 per sbloccare una nuova abilità.'
      ...
      // tr: 'Sırada, sana nasıl yeni yetenek öğrenebileceğini öğreteceğim. İlk olarak, yeni bir yetenek açmak için seviye 3\'e kadar seviye atla.'
    },
    {
      en: 'A new skill is available. You need to use books to learn new skills.',
      it: 'È disponibile una nuova abilità. Devi usare i libri per apprendere nuove abilità.'
      ...
      // tr: 'Yeni bir yetenek mevcut. Yeni yetenekleri öğrenmek için kitapları kullanmalısın.'
    },
    {
      en: 'Collect some items and coins. You need 32 coins for your first book. You can sell items to the trader as well.',
      it: 'Raccogli alcuni oggetti e monete. Hai bisogno di 32 monete per il tuo primo libro. Puoi anche vendere oggetti al commerciante.'
    ...
    },
    {
      ...
      // tr: 'Paran yeterli. Üsse geri dön, ve ye yetenek kitabını satın almak için sınıf tüccarınla konuş.'
    },
    {
      en: 'The trader sells skill books, potions, and mounts. Right-click the book to buy it.',
      it: 'Il commerciante vende libri di abilità, pozioni e cavalcature. Fai clic con il pulsante destro del mouse sul libro per acquistarlo.'
    ...
    },
    {
      ...
      // tr: 'Kitabı aldığın zaman envanterini aç. Öğrenmek için kitaba sağ tıkla ve <kbd>Use Item</kbd> seçeneğini seç.'
    },
    {
      en: 'Close the Trader Window, then open your skill panel (<kbd>K</kbd>) to see an overview of your skills.',
      it: 'Chiudi la finestra del commerciante, quindi apri il pannello delle abilità (<kbd>K</kbd>) per vedere una panoramica delle tue abilità.'
      ...
      // tr: 'Tüccat sekmesini kapat, yeteneklerini görmek için (<kbd>K</kbd>) tuşuna basarak yetenek panelini aç.'
    },
    {
      ...
      it: 'Qui puoi vedere le tue abilità. Passa il mouse su di essi per ulteriori informazioni. Le abilità di solito richiedono un punto abilità, che guadagni una volta ogni due livelli'
      ...
      // tr: 'Burada yeteneklerini görebilirsin. Fazladan bilgi için üzerlerinde dur. Yetenekler genelde bir yetenek puanı gerektirir, iki seviyede bir yetenek puanı kazanırsın.'
    },
    {
      ...
      // tr: 'Yeteneklerini istediğin zaman değiştirebilirsin. Yeteneğine bi yetenek puanı ekleyerek onu etkinleştir.'
    },
    {
    ...
    },
    {
      ...
      // tr: 'Bir yeteneği tutup yetenek çubuğuna sürükleyebilirsin. Bunu senin için zaten yaptık!'
    },
    {
      ...
      // tr: 'Baya bir şey öğrendin. Macerana başlamaya neredeyse hazırsın.'
    },
    {
      en: 'Hordes is all about working in a party with other players. A party can help you level up.',
      it: 'Orde è tutto incentrato sul lavorare in una festa con altri giocatori. Una festa può aiutarti a salire di livello.'
      ...
      // tr: 'Hordes diğer oyuncular ile bir party\'de birlikte çalışmaktır. Bir party seviye atlamana yardım edebilir.'
    },
    {
      en: 'A party of players will share experience and items, allowing them to progress faster than solo players.',
      it: 'Un gruppo di giocatori condividerà esperienza e oggetti, consentendo loro di progredire più velocemente rispetto ai giocatori solisti.'
    ...
    },
    {
      ...
      // tr: 'Party arayüzü ile bir tane kurabilir veya bulabilirsin. <kbd>Find Party</kbd> tıklayarak otomatikmen bir tane ara.'
    },
    {
      ...
      it: 'Puoi anche invitare giocatori nel tuo gruppo facendo clic con il pulsante destro del mouse sulla loro unità o usando il comando <kbd>/partyinvite</kbd>.'
      ...
      // tr: 'Ayrıca diğer oyuncuları onların birim çerçevelerine sağ tıklayarak party\'ne davet edebilirsin, yada partyinvite</kbd> komutunu kullanarak.'
    },
    {
      en: 'Partying will also allow you to share fame points in PVP combat.',
      it: 'Stare in un party ti permetterà anche di condividere punti fama nel combattimento PVP.'
      ...
      // tr: 'Party kurmak ayrıca PVP dövüşlerinde şöhret puanlarını paylaşırlar.'
    },
    {
      en: 'Players of the other faction can be killed to earn fame and items (such as the crown) for your character.',
      it: 'I giocatori di altre fazioni possono essere uccisi per guadagnare fama e oggetti (come la corona) per il tuo personaggio.'
      ...
      // tr: 'Diğer faction\'ın oyuncuları birbirlerini şöhret ve eşyalar (taç gibi) için öldürebilir.'
    },
    {
      en: 'You can also sell items to other players. You can visit the Merchant to do so.',
      it: 'Puoi anche vendere oggetti ad altri giocatori. Puoi visitare il commerciante per farlo.'
      ...
      // tr: 'Ayrıca diğer oyuncularada eşya satabilirsin. Merchantı ziyaret edebilirsin.'
    },
    {
      ...
      it: 'Tutti gli oggetti acquistati dal commerciante verranno inviati alla tua scorta, un deposito per i tuoi oggetti e oro. È una scatola marrone situata accanto al commerciante.'
      ...
      // tr: 'Merchanttan satın aldığın eşyalar stash\'ine gönderilecek - eşyaların ve altının için bir depo. Merchantın yanında duran kahverengi bir kutu.'
    },
    {
      ...
      // tr: 'Canavarları katlederk rünleri bulaiblirsin. Rünler eşyalarını yükseltmene izin verir. Bunu yapmak için demirciyi ziyaret et.'
    },
    {
      ...
      // tr: 'Oyuncularla koordinasyonlu olmak önemlidir. <kbd>/global</kbd>, <kbd>/party</kbd>, <kbd>/faction</kbd> ve <kbd>/clan</kbd> kullanabilirsin. Sohbet için entere bas.'
    },
    {
      en: 'Type in your greatest battle shout. Then press enter to send your love letter to the world.',
      it: 'Digita il tuo più grande grido di battaglia. Quindi premi invio per inviare la tua lettera di san valentino al mondo.'
      ...
      // tr: 'En büyük savaş çığlığını yaz. Sonra entere basarak aşk mektubunu tüm dünyaya gönder.'
    },
    {
      en: 'See the cogwheel in the upper right corner? Open your game settings.',
      it: 'Vedi la ruota dentata in alto a destra? Apri le impostazioni di gioco.'
      ...
      // tr: 'Sağ üst köşedeki dişliyi gördün mü? Oyun ayarlarını aç.'
    },
    {
      en: 'You can change many things here, such as the controls, language, or reducing the graphics.',
      it: 'Puoi cambiare molte cose qui, come i controlli, la lingua o la riduzione della grafica.'
      ...
      // tr: 'Buradan bay bir şeyi değiştirebilirsin, kontroller, dil, ya da grafikleri düşürmek gibi.'
    },
    {
      ...
      // tr: 'pekala, ayarları yeniden kapat.'
    },
    {
      ...
      // tr: 'Oldu işte. Başardın. Katletmek için hazırsın. Faction\'un sana bağlı.'
    },
    {
      en: 'Good luck, champion.',
      it: 'uona fortuna, campione.'
      // pt: 'Boa sorte, campeâo'
      // fr: 'Bonne chance, champion.'
      // cs: 'Hodně štěstí šampione.'
      // tr: 'İyi şanslar şampiyon.'
    },
    {
      en: 'Congratulations on Lv. 25! You can now enter Headless Landing, a new world. Speak to the Conjurer in your base.',
      it: 'Congratulazioni per Lv. 25! Ora puoi entrare in Headless Landing, un nuovo mondo. Parla con il Prestigiatore nella tua base.'
      ...
      // tr: '25. seviyeye ulaşmanda tebrikler! Şimdi Headless Landing\'e girebilirsin, yeni bir dünya. Üssündeki Conjurer ile konuş.'
    }
  ]
}
