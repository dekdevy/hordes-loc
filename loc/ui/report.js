...
export default {
  reasons: [
    { en: 'Offensive Chat', ru: 'Оскорбления в чате' },
    { en: 'Multiboxing', ru: 'Множественные аккаунты' },
    { en: 'Scamming', ru: 'Мошенничество' },
    { en: 'Cheating / Exploiting', ru: 'Читы / Взлом' },
    { en: 'Offensive Name',  ru: 'Оскорбительное имя' },
    { en: 'Botting', ru: 'Бот' }
  ],
  info: [
