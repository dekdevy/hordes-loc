...
export default {
  ...
  info: [
    { 
      ...
      // ru: 'Спам, оскорбительные выражения (явные, ЛГБТ-фобические, расистские, и NSFW и др.), олицетворение, доксинг, рекламные вещи, которые нарушают TOS. Обратите внимание, что допускается легкое подшучивание. Не сообщайте о нескольких сообщениях; одного отчета будет достаточно.'
    },
    { 
