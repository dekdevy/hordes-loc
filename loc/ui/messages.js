export default {
  ...
  clanMemberInvite: {
    ...
    pt: '$1 foi convidado para o seu clã.',
  ...
  clanMemberApply: {
    ...
    pt: '$1 se increveu para entrar no seu clã.',
  ...
  clanMemberRolePromote: {
    ...
    pt: '$1 foi promovido de função no clã.',
  ...
  clanMemberRoleDemote: {
    ...
    pt: '$1 foi rebaixado de função no clã.',
  ...
  partyMemberInvite: { // Do not translate "party".
    ...
    pt: '$1 foi convidado por $2 para se juntar a sua Party.',
    ...
    sr: '$2 је позвао $1 да се придружи твојој Party.',
  ...
  partyInvitationDecline: { // Do not translate "party".
    ...
    pt: '$1 recusou-se a participar da sua Party.',
    ...
    zh: '$1 拒絕加入你的 Party。',
    sr: '$1 је одбио да се придружи твојој Party.',
  ...
  partyMemberPromote: { // Do not translate "party".
    ...
    pt: '$1 foi promovido de função na Party.',
    ...
    zh: '$1 Party 職位提升。',
    sr: 'Party улога од $1 је унапређена.',
  ...
  partyMemberFound: { // Do not translate "party".
    ...
    zh: '找到 $1 新的 Party 成員。',
    sr: 'Пронађено је $1 нових Party чланова.',
    it: 'Trovato $1 nuovo membro del party.',
    hu: '$1 új Party társ lett találva',
    pt: 'Encontrado $1 novo(s) membro(s) para party',
  ...
  partyInviteLink: {
    ...
    sr: '$1 је креирао позивницу за Party: $2.',
  ...
  partyQueueStart: { // Do not translate "party".
    ...
    pt: 'Sua Party iniciou uma fila: $1',
  ...
  auctionSold: {
    ...
    pt: 'Sua oferta no Merchant foi vendida e $g$1 foram enviadas para o seu Stash.',
