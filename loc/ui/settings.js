export default {
  ...
  multiplierdesc: {
    ...
    pt: 'Feitiços não lançados por você podem ser reduzidos em volume. 100% = Sem redução de som, 50% = metade do volume.'
  },
