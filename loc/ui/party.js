export default {
  ...
  */
  ...
  onLink: {
      ...
      ph: 'Ipadala ang link na ito sa ibang mga manlalaro! Ito ay magpapahintulot sa kanila na sumali sa iyong partido.',
      bg: 'Изпратете тази връзка на други играчи! Това ще им позволи да се присъединят към вашата партия.',
      el: 'Στείλτε αυτό το σύνδεσμο σε άλλους παίκτες! Αυτό θα τους επιτρέψει να ενταχθούν στο κόμμα σας.',
