export default {
  ...
  description: {
    ...
    es: 'Los guerreros están construidos para lanzar más monstruos que cualquier otra clase al tener una alta defensa a través del equipo (Escudos) y fuertes aficionados defensivos.',
