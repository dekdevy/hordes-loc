export default {
  ...
  description: {
    ...
    pt: 'Os guerreiros são construídos para resistir a mais monstros do que qualquer outra classe, tendo alta defesa através de equipamentos (Escudos) e fortes buffs defensivos.',
