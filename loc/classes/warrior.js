export default {
  ...
  description: {
    ...
    pt-BR: 'Os guerreiros são feitos para absorver mais danos de monstros que qualquer outra classe, visto que eles possuem alta defesa obtida por equipamento (Escudos) e fortes buffs defensivos.',
