export default {
  ...
  description: {
    ...
    es: 'Los magos infligen daños a gran escala a gran escala en el área de efecto, a la vez que proporcionan utilidad a través de la ralentización de los objetivos con su magia basada en el hielo.',
