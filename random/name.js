...
const syllables = ['heim', 'tuk', 'ta', 'lor', 'bok', 'le', 'me', 'ka', 'na', 'pink', 'dumb', 'fizz', 'glink', 'bing',
  ...
  'nek', 'kar', 'sark', 'bound', 'bo', 'ork', 'mark', 'raw', 'dork', 'deku', 'fin', 'pas', 'loc', 'rev', 'dmi', 'ove', 'hug', 'club',
   'next', 'people', 'metal', 'iron', 'eyes', 'red', 'green', 'brown', 'purple', 'yellow', 'white', 'rekt', 'blood', 'milk', 'black',
   'brody', 'aris', 'cap', 'plant', 'sad', 'cookie']
